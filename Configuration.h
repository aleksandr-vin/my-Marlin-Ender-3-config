...
//#define Z_MIN_PROBE_PIN 17 // Creality V4.2.7 BLTouch OUT (written on the board)
...
#define NOZZLE_TO_PROBE_OFFSET { -40, -10, 0} // from https://github.com/Flawioo/Creality-Ender-3-board-v4.2.7/blob/master/README.md
